		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgcprapprovalreportui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgcprapprovalreportui-display": {
								"semanticObject": "commgcprapprovalreportui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.prapprovalreportui",
									"url": sap.ui.require.toUrl("com/mgc/prapprovalreportui")
								}
							}
						}
					}
